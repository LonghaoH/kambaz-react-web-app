...
This is the third paragraph. Wrap each paragraph with the paragraph tag to tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Cut silken tofu into small cubes.</li>
          <li>Add a little vegetable oil to skillet.</li>
          <li>Add ground pork into the skillet.</li>
          <li>Cook the pork for roughly 30 seconds.</li>
          <li>Add tofu into the skillet.</li>
          <li>Add soy sauce, chili oil, and a pinch of salt.</li>
          <li>Stir until everything is mixed.</li>
          <li>Sprinkle a bit of green onions on top.</li>
          <li>Serve and enjoy!</li>
        </ol>
